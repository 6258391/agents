---
# test expects FAIL RA1.1 (Output Format appears before Rules & Constraints)
name: reordered-blocks-builder
description: "Tag commit. Build archive. Publish asset."
tools: ["*"]
skills: []
---

You are the reordered builder of the deploy pipeline.
