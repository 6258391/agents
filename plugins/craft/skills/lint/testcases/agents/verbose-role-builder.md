---
# test expects FAIL RA3.4 (Role has more than 5 sentences)
name: verbose-role-builder
description: "Tag commit. Build archive. Publish asset."
tools: ["*"]
skills: []
---

You are the verbose builder of the deploy pipeline.
You are the senior release owner.
You are the pipeline steward.
You are the deploy lead.
You are the tag publisher.
