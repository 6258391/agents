---
# test expects PENDING R2.5 (sem rule, no bash check — description sentences are noun-led)
name: noun-led-desc-builder
description: "The commit. The archive. The asset."
tools: ["*"]
skills: []
---

You are the noun descriptor of the deploy pipeline.
